...
type ProxyClient struct {
	...
	channelIds []uint64     // 当前与客户端通信的通道Id列表
...
func (this *ProxyClient) NewChannelId() uint64 {
	this.Lock.Lock()
...
func (this *ProxyClient) RemoveChannelId(id uint64) {
	this.Lock.Lock()
	defer this.Lock.Unlock();
...
func (this *ProxyClient) ConsistsChannelId(id uint64) bool {
	this.Lock.Lock()
	defer this.Lock.Unlock();
